...
export function AdminView(props: { accounts: Array<Account>; query: string | null; page: number; totalPages: number; totalCount: number }): HtmlEscapedString | Promise<HtmlEscapedString> {
