...
export const GlobalConfig = {
	...
	TIMEOUT_SESSION: 7 * 1000 * 60 * 60 * 24,
	TIMEOUT_VERIFY_EMAIL: 30 * 1000 * 60 * 60 * 24,
	TIMEOUT_PASSWORD_RESET: 2 * 1000 * 60 * 60,
	TIMEOUT_INACTIVITY_LAST_VISIT_REFRESH: 1 * 1000 * 60 * 60,
	TIMEOUT_PRIVILEGE_ELEVATION: 10 * 1000 * 60, // 10 minutes
};
